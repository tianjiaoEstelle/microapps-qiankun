...
<template>
  <el-container class="form-canvas">
    <el-header><div class="top-title">默认简历模板列表</div> </el-header>
    <el-container>
      <!-- 内容 -->
      <el-main>
...
export default class EnrollDefaultList extends Vue {
  ...
  addRow() {
    ...
    this.$nextTick(function () {
      this.dialogFormRef.resetFields()
    })
  }
